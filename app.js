...
function getQRNumber() {
    ...
    // If there's no "qr" param at all, Number(null) would be 0
    // (a valid-looking integer), which wrongly triggered the
    // "QR Not Found" screen instead of the home screen.
    if (!params.has("qr")) {
        return null;
    }
...
function showLocked(qrNumber) {
    ...
    game.innerHTML = `
        ...
        <p>
            You have used both attempts on QR ${qrNumber}
            and did not answer correctly.
        </p>
...
function checkAnswer(
    ...
    if (
        ...
        message.innerHTML = `
            ...
            You have used both attempts and
